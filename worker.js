...
<body>
  ...
  <main class="main-content"><header class="page-header"><div><div class="page-title" id="pageTitle">營運統計</div><div class="page-subtitle" id="pageSubtitle">以 HookTea 後台結構管理 CRM、商城、點數與經銷商歸屬</div></div><div class="header-actions"><span class="status-badge" id="systemStatus">連線中</span><input id="adminToken" type="password" placeholder="Admin token"><button class="btn-outline" id="saveToken">儲存</button><button class="btn-green-main" id="refreshAll">更新</button></div></header><div class="content">
    ...
    <section class="view" id="view-customers"><section class="panel"><div class="panel-header"><div><div class="section-title">客戶 CRM</div><div class="muted">加入官方帳號即建檔，列表仿 HookTea 以 LINE 名稱與 UID 為主</div></div><input id="customerSearch" placeholder="搜尋 LINE 名稱 / UID"></div><div class="admin-table-container"><table class="admin-table"><thead><tr><th>LINE 名稱</th><th>LINE UID</th><th>業務歸屬</th><th>最近互動</th><th>操作</th></tr></thead><tbody id="customerRows"></tbody></table></div></section><section class="panel" id="customerDetailPanel" style="display:none"><div class="panel-header"><div><div class="section-title">CRM 檔案</div><div class="muted" id="customerDetailSub">會員詳細資料、業務歸屬與點數操作</div></div><button class="btn-outline btn-small" id="closeCustomerDetail">關閉</button></div><div class="panel-body"><div class="ops-list" id="customerDetailCards"></div><div class="form-grid" style="margin-top:14px"><input id="pointAmount" type="number" placeholder="點數數量"><input id="pointReason" placeholder="異動原因"><button class="btn-green-main" id="grantPoints">贈點</button><button class="btn-outline" id="deductPoints">扣點</button></div><div class="muted" id="pointStatus"></div></div><div class="admin-table-container"><table class="admin-table"><thead><tr><th>時間</th><th>類型</th><th>點數</th><th>內容</th><th>餘額</th></tr></thead><tbody id="pointRows"></tbody></table></div></section></section>
