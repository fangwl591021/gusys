...
<body>
  ...
  <aside class="checkout-sheet" id="checkoutSheet" aria-label="購物車結帳">
    ...
    <div class="sheet-body">
      ...
      <div class="summary-lines"><div class="summary-line"><span>商品小計</span><span id="cartSubtotal">$0</span></div><div class="summary-line"><span>點數折抵</span><span id="cartDiscount">-$0</span></div><div class="summary-line total-final"><span>合計</span><span id="cartTotal">$0</span></div></div><div class="redeem-box"><div class="redeem-row"><label class="field"><span>使用點數折抵</span><input id="pointDiscount" type="number" min="0" step="1" value="0" inputmode="numeric" placeholder="0"></label><button class="secondary" id="maxPointDiscount" type="button">全部可用</button></div><div class="hint" id="pointRedeemHint">可用點數讀取中</div></div>
