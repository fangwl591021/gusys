...
async function callWetwPointQuery(env, input) {
  ...
  if (input.pointType || cfg.pointType) payload.point_type = String(input.pointType || cfg.pointType).trim();
